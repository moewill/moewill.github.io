# Maurice Rashad Tech Services

This repository contains both the original portfolio website and the new Nagara-inspired redesign.

## Current Working Directory
All development work is happening in the root directory (nagara-redesign has been moved to root for GitHub Pages deployment)
...
### Original Portfolio (archived in `.archived/`)
...
### Nagara Redesign (root directory)
